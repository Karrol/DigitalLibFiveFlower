    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=255, verbose_name='分类目录')),
                ('title', models.CharField(max_length=30, verbose_name='题名')),
                ('cover', models.CharField(blank=True, max_length=30, verbose_name='封面')),
                ('location', models.CharField(blank=True, max_length=70, verbose_name='馆藏地点')),
                ...
                ('quantity', models.CharField(blank=True, max_length=10, verbose_name='馆藏数目')),
