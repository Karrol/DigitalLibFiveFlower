...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='booktop_info',
            fields=[
                ('number', models.AutoField(primary_key=True, serialize=False, verbose_name='序号')),
                ('bookName', models.CharField(max_length=50, verbose_name='书名')),
                ('bookAuthor', models.CharField(max_length=50, verbose_name='作者')),
                ('bookConcern', models.CharField(max_length=50, verbose_name='出版社')),
                ('ISBN', models.CharField(max_length=50, verbose_name='ISBN号')),
                ('pub_display', models.BooleanField(default=False, verbose_name='正式发布')),
            ],
            options={
                'verbose_name': '排行榜',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bookName', models.CharField(max_length=50, verbose_name='书名')),
                ('bookID', models.CharField(max_length=10, verbose_name='书籍编码')),
                ...
                ('now_display', models.BooleanField(default=False, verbose_name='本周推荐')),
                ('past_display', models.BooleanField(default=False, verbose_name='历史推荐')),
        ...
        migrations.AddField(
            ...
            name='newsColumn',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='infoCenter.newsColumn_info', verbose_name='归属栏目'),
        ),
    ]
